...
export const articleCardClass =
  "bg-[#f5f5f7] p-7 hover:bg-[#ebebf0] transition-colors duration-200 flex flex-col gap-2.5 cursor-pointer overflow-hidden";
export const articleTitle =
  "text-base font-semibold text-[#1d1d1f] leading-snug tracking-tight whitespace-normal wrap-anywhere";
export const articleExcerpt = "text-sm text-[#6e6e73] leading-relaxed whitespace-normal wrap-anywhere";
export const articleMeta = "text-xs text-[#a1a1a6]";
export const articleBody = "text-[#6e6e73] leading-[1.85] text-[0.95rem] max-w-2xl whitespace-normal wrap-anywhere";
...
export const articleMainTitle =
  "text-4xl font-bold text-[#1d1d1f] leading-tight tracking-tight whitespace-normal wrap-anywhere";
...
export const articleContent = "text-[#1d1d1f] leading-[1.9] text-[1rem] whitespace-pre-line mt-8 wrap-anywhere";
